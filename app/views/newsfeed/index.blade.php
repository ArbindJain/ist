...
<div class="col-md-12">
  <div class="feed-changer centertab">
    <a href="" class="btn btn-link userfeed" id="user" >User Feed</a>
    <a href="" class="btn btn-link corporatefeed" id="corporate" >Corporate Feed</a>
  </div>
</div>
...
<div class="col-md-12" id="corporatediv" class="cdiv" style="display:none;">
  <div class="col-md-8">
    <h1>No corporate feed Available </h1>
  </div>
  <div class="col-md-4"></div>
</div><!-- 3rd md 12 -->
