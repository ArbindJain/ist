	                    ...
	                    <fieldset>
							...
							<div class="form-group">
								<div class='input-group date' id='datetimepicker1'>
				                    {{ Form::text('eventdatetime', null, ['placeholder' => 'Event Name', 'class' => 'form-control', 'required' => 'required'])}}
							...
							<!-- Submit field -->
							<div class="form-group">
								{{ Form::submit('Create Event', ['class' => 'btn btn-lg btn-primary btn-block']) }}
							</div>
