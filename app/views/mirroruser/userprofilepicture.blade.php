  ...
  <div class="col-md-12">
    <div class="sub-nav-block">
      <ul class="nav nav-pills centertab">
        <li role="navigation" class="active"><a href="{{url()}}/userprofile/{{$userprofile->id}}?{{$userprofile->name}}#photo">Photo</a></li>
        <li role="navigation"><a href="{{url()}}/userprofile/{{$userprofile->id}}?{{$userprofile->name}}#video">Video</a></li>
        <li role="navigation"><a href="{{url()}}/userprofile/{{$userprofile->id}}?{{$userprofile->name}}/profile#audio">Audio</a></li>
        <li role="navigation"><a href="{{url()}}/userprofile/{{$userprofile->id}}?{{$userprofile->name}}/profile#recent">Recent Activity</a></li>
        <li role="navigation"><a href="{{url()}}/userprofile/{{$userprofile->id}}?{{$userprofile->name}}/profile#blog">Blog</a></li>
        <li role="navigation"><a href="{{url()}}/userprofile/{{$userprofile->id}}?{{$userprofile->name}}/profile#about">About</a></li>
      </ul>
    </div>
